...
class Main:
    def main():
        ...
        def showAbout():
            ...
            print("#Developed by Renato Simoes - renato.simoes@ifsc.edu.br")
        ...
        for prot in proteins:
            try:
                ...
                line = [
                    ...
                    "{:.2f}".format(hydrophobicity(prot.sequence)),
                ...
                print("An error occurred during processing the protein " + prot.id)
